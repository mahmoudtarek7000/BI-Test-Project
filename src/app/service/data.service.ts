...
export class DataService extends BehaviorSubject<any> implements IDataService {
    ...
    loading = true;
    APIURL!: string;
    Token: string = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..M9Esl9c4pgZE5LX-pKVYmXebbwjmLaCCR_yy8UaPdQU'
