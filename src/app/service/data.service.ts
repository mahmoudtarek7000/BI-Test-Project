...
export class DataService extends BehaviorSubject<any> implements IDataService {
    ...
    loading = true;
    APIURL!: string;
    Token: string = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..VC3cuMNxUzFVM4fnVEmKRRxpTUEQOKIEbDr1fWyoHlg'
